...
@WebServlet(name = "RechercheVoituresServlet", urlPatterns = {"/RechercheVoituresServlet"})
public class RechercheVoituresServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public RechercheVoituresServlet() {
        super();
    }

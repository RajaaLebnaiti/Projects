...
<head>
    ...
    <style>
        body {
            ...
            background-image: url("/LocationVoituresApp/images/backgroundPers.jpg");
...
<body>
    <div class="login-container">
        <div class="login-box">
            ...
            <h2>Bienvenue</h2>
            <form action="LoginPersonelServlet" method="post">
                ...
                <p><a href="RecuperationDonnesPersonnel.jsp">Nom d'utilisateur ou mot de passe oublié ?</a></p>
            </form>
